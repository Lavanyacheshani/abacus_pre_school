...
import { BookOpen, Sparkles, ClipboardCheck, Clock, ArrowUpRight } from "lucide-react"

const eyfsAreas = [
    { code: "PSED", title: "Personal, Social and Emotional Development" },
    { code: "CL", title: "Communication and Language" },
    { code: "PD", title: "Physical Development" },
    { code: "L", title: "Literacy" },
    { code: "M", title: "Mathematics" },
    { code: "UTW", title: "Understanding the World" },
    { code: "EAD", title: "Expressive Arts and Design" },
]
                ...
                <div className="container mx-auto px-4 relative py-14 md:py-20">
                    <motion.div variants={container} initial="hidden" animate="show" className="max-w-5xl mx-auto">
                        ...
                        <motion.div variants={item} className="mt-8 grid gap-4 md:grid-cols-3">
                            <InfoPill icon={<BookOpen className="h-4 w-4" />} title="Sent home half-termly" text="So you can add your child’s voice at home." />
                            <InfoPill icon={<Clock className="h-4 w-4" />} title="Return within one week" text="So we can continue recording progress." />
                            <InfoPill icon={<ClipboardCheck className="h-4 w-4" />} title="Shared with your key person" text="Ask questions anytime about development." />
                        </motion.div>
                    </motion.div>
                </div>
            </section>
                                    ...
                                    <div className="relative rounded-[22px] bg-white/80 backdrop-blur-md border border-white/70 shadow-[0_18px_60px_rgba(0,0,0,0.10)] p-6">
                                        ...
                                        <div className="mt-5 grid gap-3">
                                            {eyfsAreas.map((a) => (
                                                ...
                                                >
                                                    <div className="mt-0.5 inline-flex h-7 w-10 items-center justify-center rounded-xl bg-white/70 border border-white/70 text-dark-teal text-xs font-bold">
                                                        {a.code}
                                                    </div>
                                                    <div className="text-sm text-dark-teal/90 leading-snug">{a.title}</div>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                            ...
                            <div className="lg:col-span-5">
                                ...
                                >
                                    <div>
                                        ...
                                        <div className="text-base font-bold text-dark-teal leading-tight">
                                ...
                                <p className="mt-3 text-xs text-sage">
                                    Alternatively, your child’s key person can share the guide with you.
                                </p>
                            </div>
                        </motion.div>
                    </motion.div>
