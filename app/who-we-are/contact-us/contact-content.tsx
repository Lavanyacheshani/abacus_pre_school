            ...
            <section className="relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative pt-14 pb-8 md:pt-20 md:pb-10">
                    <motion.div variants={container} initial="hidden" animate="show" className="max-w-6xl mx-auto">
                        ...
                        <motion.h1
                            variants={item}
                            className="mt-5 text-4xl md:text-6xl font-bold text-dark-teal tracking-tight"
                        >
                            Contact{" "}
                        ...
                        <motion.p
                            variants={item}
                            className="mt-4 text-lg md:text-xl text-sage max-w-3xl leading-relaxed"
                        >
                        ...
                        <div className="grid gap-6 lg:grid-cols-12 items-stretch">
                            ...
                            <motion.div variants={item} className="lg:col-span-5 space-y-6">
                                <InfoCard
                                    ...
                                    body={
                                        <>
                                            ...
                                            <div className="mt-4">
                                                <a
                                                    href="https://www.google.com/maps?q=1+Cambridge+Rd,+New+Malden,+KT3+3QE"
                                                    target="_blank"
                                                    rel="noreferrer"
                                ...
                                <InfoCard
                                    ...
                                    body={
                                        <>
                                            <p className="font-semibold text-dark-teal">Monday – Friday</p>
                                            <p>9:00 am – 3:00 pm</p>
                                        </>
                                    }
                                />
