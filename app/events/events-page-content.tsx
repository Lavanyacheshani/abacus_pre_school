...
export function EventsPageContent() {
    ...
    // Calendar items (single-day markers). Edit anytime.
    ...
    // Past + Upcoming term blocks (your exact content)
    const pastBlocks: TermBlock[] = [
        {
    ...
    const upcomingBlocks: TermBlock[] = [
        {
                ...
                <div className="container mx-auto px-4 relative pt-14 pb-8 md:pt-20 md:pb-10">
                    <motion.div variants={container} initial="hidden" animate="show" className="max-w-6xl mx-auto">
                        ...
                        >
                            ...
                            <span className="text-sm font-medium text-dark-teal">Dates, closures and key events</span>
                        </motion.div>
                        ...
                        <motion.p variants={item} className="mt-4 text-lg md:text-xl text-sage max-w-3xl leading-relaxed">
                            Use the calendar for a quick view, or switch to lists for upcoming and past term dates.
                        </motion.p>
                            ...
                            <button
                                ...
                                className={[
                                    ...
                                    tab === "calendar"
                                        ...
                                        : "bg-white/70 text-dark-teal border-white/70 hover:bg-white",
                                ].join(" ")}
                            >
                                Calendar view
                            </button>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className="flex items-start justify-between">
                                                            ...
                                                            {isToday ? <span className="text-[10px] font-semibold text-teal">Today</span> : null}
                                                        </div>
                                    ...
                                    <div className="relative rounded-[22px]">
                                        ...
                                        <div className="relative rounded-[22px] bg-white/85 backdrop-blur-md border border-white/70 shadow-[0_18px_60px_rgba(0,0,0,0.10)] p-6">
                                            ...
                                            <div className="mt-5 space-y-3">
                                                {selectedEvents.length === 0 ? (
                                                    ...
                                                    selectedEvents.map((e) => (
                                                        <div key={e.id} className="rounded-2xl border border-sage/15 bg-white/70 px-4 py-4">
                                                            ...
                                                            {e.description ? <p className="mt-2 text-sm text-sage leading-relaxed">{e.description}</p> : null}
                                            ...
                                            <div className="mt-6 flex flex-col sm:flex-row gap-3">
                                                <Button asChild className="rounded-full bg-teal hover:bg-dark-teal text-cream px-6 shadow-[0_14px_30px_rgba(0,0,0,0.12)]">
                            ...
                            <>
                                <motion.div variants={item} className="grid gap-6">
                                    {upcomingBlocks.map((block, i) => (
                                        <div key={i} className="relative rounded-[22px]">
                                            <div className="absolute -inset-[1px] rounded-[22px] bg-gradient-to-br from-teal/18 via-white/0 to-coral/18 blur-[16px] opacity-70" />
                                ...
                                <motion.div variants={item} className="mt-10 text-center">
                                    <div className="inline-flex flex-col items-center gap-3">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-3">
                                            <Button asChild className="rounded-full bg-teal hover:bg-dark-teal text-cream px-7 shadow-[0_14px_30px_rgba(0,0,0,0.12)]">
                                            ...
                                            <Button
                                                type="button"
                                                variant="outline"
                                                className="rounded-full border-sage/25 bg-white/70 text-dark-teal hover:bg-white px-7"
                                                onClick={() => setTab("calendar")}
                                            >
                                                Back to calendar
                                            </Button>
                                        ...
                                        <div key={i} className="relative rounded-[22px]">
                                            ...
                                            <div className="relative rounded-[22px] bg-white/85 backdrop-blur-md border border-white/70 shadow-[0_18px_60px_rgba(0,0,0,0.10)] p-6 md:p-8">
                                                <div className="flex items-start justify-between gap-4 flex-wrap">
                                                    <div>
                                                        <h2 className="text-2xl md:text-3xl font-bold text-dark-teal">{block.termTitle}</h2>
                                                        {block.subtitle ? <p className="mt-2 text-sm text-sage leading-relaxed">{block.subtitle}</p> : null}
                                                    </div>
